...
func TestParseWikiURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			url:           "https://feishu.cn/wiki/settings/7123456789012345678",
			wantPrefixURL: "https://feishu.cn",
		...
		},
		{
			...
			url:           "https://feishu.cn/wiki/abc123XYZ",
			wantPrefixURL: "https://feishu.cn",
			wantSpaceID:   "",
		...
		},
		{
			...
			url:           "https://feishu.cn/wiki/nodeToken123?from=wiki_home",
			wantPrefixURL: "https://feishu.cn",
			wantSpaceID:   "",
		...
		{
			name:          "larksuite URL",
			url:           "https://larksuite.com/wiki/settings/spaceABC",
			wantPrefixURL: "https://larksuite.com",
