...
func TestMdStr2DocxCodeLang(t *testing.T) {
	tests := map[string]lark.DocxCodeLanguage{
		...
		// 飞书新增语言（枚举 68-75）规范名
		"cmake":      lark.DocxCodeLanguageCMake,
		"diff":       lark.DocxCodeLanguageDiff,
		"gherkin":    lark.DocxCodeLanguageGherkin,
		"graphql":    lark.DocxCodeLanguageGraphQL,
		"glsl":       lark.DocxCodeLanguageGLSL,
		"properties": lark.DocxCodeLanguageProperties,
		"solidity":   lark.DocxCodeLanguageSolidity,
		"toml":       lark.DocxCodeLanguageTOML,
		// 飞书新增语言的官方别名
