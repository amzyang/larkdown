...
const DeviceFlowScope = "docx:document:readonly docs:document.content:read wiki:wiki:readonly drive:file:readonly drive:drive:readonly bitable:app:readonly drive:export:readonly docs:document.media:download board:whiteboard:node:read docs:document.comment:read contact:contact.base:readonly contact:user.basic_profile:readonly wiki:node:create docx:document.block:convert docx:document:write_only docs:document.media:upload board:whiteboard:node:create spark:app:write search:docs:read"
